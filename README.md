...
Example accounts for testing real mode:
- Email: `pangpond1@gmail.com`
- Password: `za0887824455`
...
### Demo Mode
This project includes a **Demo Mode** for testing and presentation purposes.

In Demo Mode:
- Users can explore the system without affecting real application data
- Demo data is separated from real data in the database
- A top banner is displayed to clearly indicate whether the user is in **Demo Version** or **Real Program**
- Users can switch between Demo Mode and Real Program from the top banner
- Demo pages are designed for showcasing the application safely

Demo account:
- Email: `demo@todoapp.com`
- Password: `demo123456`

Demo Mode uses sample users, categories, members, and tasks to simulate a real working environment.
...
In the **All Tasks** page:
- Only the task creator can change the task status (`Pending / Doing / Done`)
- Other tagged users can view the task but cannot modify its status
- In Demo Mode, data is displayed separately from the real system
...
- Display workspace members on dashboard and member page
- Keep workspace member relationships separated by mode (`real` / `demo`)
...
## Data Modes
This project supports two separated modes of data:

### Real Mode
- Used when users log in with real registered accounts
- Stores and loads actual user data

### Demo Mode
- Used for presentation and safe testing
- Does not affect real user data
- Loads demo-only users, tasks, categories, and workspace members

This separation helps prevent accidental modification of real application data while still allowing the system to be demonstrated.

## Source Code
You can view the full source code and project details on GitHub:

- https://github.com/PangPond256/my-todo-app
